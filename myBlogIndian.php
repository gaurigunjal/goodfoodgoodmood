	...
	<div class="row" style="margin-top: 40px">
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Dosa</b>
				<a href="myBlogImg4.php">
					<img style="width: 100%" src="img4.jpg">
					</a>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Gulabjamun</b>
				<a href="myBlogImg5.php">
					<img style="width: 100%" src="img5.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Biryani</b>
				<a href="myBlogImg6.php">
					<img style="width: 100%" src="img6.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
