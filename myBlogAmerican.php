	...
	<div class="row" style="margin-top: 40px">
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>S'mores dip</b>
				<a href="myBlogImg10.php">
				
					<img style="width: 100%" src="img10.jpg">
					</a>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Texas BBQ medley</b>
				<a href="myBlogImg11.php">
					<img style="width: 100%" src="img11.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Cheesesteak hot dogs</b>

				<a href="myBlogImg12.php">
					<img style="width: 100%" src="img12.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
