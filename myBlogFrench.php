	...
	<div class="row" style="margin-top: 40px;">
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Steak Diane</b>
				<a href="myBlogImg7.php">
					<img style="width: 100%; height: 260px" src="img7.jpg">
					</a>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Pain au Chocolat</b>
				<a href="myBlogImg8.php">
					<img style="width: 100%;height: 260px" src="img8.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
		...
		<div class="col-md-4">
			<div class="single-blog">
				<p class="blog-meta">
				<b>Mocha Dacquoise Cake</b>
				<a href="myBlogImg9.php">
					<img style="width: 100%" src="img9.jpg">
					</a>
					<table border="2" class="text-center" style="width: 100%">
						<tr>
							<td>Difficulty level</td>
